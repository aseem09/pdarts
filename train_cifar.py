...
parser.add_argument('--arch', type=str, default='CL_7', help='which architecture to use')
...
args.save = '/ceph/aseem-volume/full/eval/05_11/logging'
args.tmp_data_dir = '/ceph/aseem-volume/full/eval/05_11/data'
