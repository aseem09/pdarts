...
parser.add_argument('--arch', type=str, default='CL_8', help='which architecture to use')
...
args.save = '/ceph/aseem-volume/full/eval/05_12/logging'
args.tmp_data_dir = '/ceph/aseem-volume/full/eval/05_12/data'
